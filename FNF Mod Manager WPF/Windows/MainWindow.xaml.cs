...
namespace Windows
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            MessageBox.Show("Mod Shelf is under construction at the moment. Wait for the next -a update to release!", "Error");
        }
        ...
        private void Updates_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (version != realVersion)
            {
                ...
                try
                {
                    var PrcInfo = new ProcessStartInfo(@"..\FNF Mod Manager Updater.exe");
                    PrcInfo.WorkingDirectory = @"..\";
